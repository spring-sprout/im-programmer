...
public class ProblemA {
	...
	final static String input = "/Users/pgmnle/dev/google_code_jam_2011/A-large (2).in";
	...
	public static void main(String arg[]) throws Exception{
		...
		//TODO solve problem.
		for(String s:prob){
			Thread t = new Thread(new SolveA(s,i));
			t.start();
			i ++;
		}
		...
		IoUtil.txtFileOut(output, "/Users/pgmnle/dev/google_code_jam_2011/output_q_pA_s.txt");
